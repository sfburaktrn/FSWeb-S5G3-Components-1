...
function haberYapici(haberler) {
  const haberx = document.createElement("div");

  haberx.classList.add("article");

  const h2yiYap = document.createElement("h2");
  h2yiYap.textContent = haberler.baslik;
  haberx.appendChild(h2yiYap);

  const trh = document.createElement("p");
  trh.classList.add("tarih");
  trh.textContent = haberler.tarihi;
  haberx.appendChild(trh);

  const paragrafone = document.createElement("p");
  paragrafone.textContent = haberler.ilkParagraf;
  haberx.appendChild(paragrafone);

  const paragraftwo = document.createElement("p");
  paragraftwo.textContent = haberler.ikinciParagraf;
  haberx.appendChild(paragraftwo);

  const paragrafthree = document.createElement("p");
  paragrafthree.textContent = haberler.ucuncuParagraf;
  haberx.appendChild(paragrafthree);

  const butonYap = document.createElement("span");
  butonYap.classList.add("expandButton");
  butonYap.textContent = "+";

  haberx.appendChild(butonYap);
...
const articleD = document.querySelector(".articles");

data.forEach((node) => {
  articleD.appendChild(haberYapici(node));
});
